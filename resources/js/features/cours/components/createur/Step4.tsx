                ...
                <div className="lg:col-span-7 space-y-6">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-200 shadow-xs p-6 space-y-5">
                        <div className="border-b border-gray-100 pb-3">
                            ...
                            <p className="text-xs text-gray-400 mt-0.5">
                                Sélectionnez la formule d'accès la plus adaptée
                                à vos étudiants ivoiriens.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            ...
                            >
                                ...
                                <p className="text-[10px] text-gray-500 leading-tight">
                                    Accès à vie à tout le cours avec un seul
                                    achat BAC.
                                </p>
                            </div>
                            ...
                            >
                                ...
                                <p className="text-[10px] text-gray-500 leading-tight">
                                    Accès libre pour accroître votre notoriété.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-1.5 pt-2">
                            ...
                            <p className="text-[10px] text-gray-400">
                                Fourchette conseillée pour un cours de
                                spécialité Terminale : 10 000 à 25 000 FCFA.
                            </p>
                        </div>
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    <span className="text-xs font-bold text-amber-950 block">
                                        Activer la promotion de lancement
                                    </span>
                                    <span className="text-[10px] text-amber-900">
                                        Stimulez les premières inscriptions dès
                                        la mise en ligne
                                    </span>
                                </div>
                                <button
                                ...
                                >
                                    <span
                                        className={`w-4 h-4 bg-white rounded-full absolute top-1 transition-transform ${isPromoActive ? "right-1" : "left-1"}`}
                                    />
                                </button>
                            </div>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-200 shadow-xs p-6 space-y-5">
                        ...
                        <div className="text-[11px] text-gray-500 bg-gray-50 p-3 rounded-xl border border-gray-100 flex items-center gap-2">
                            ...
                            <span>
                                <strong>
                                    Frais de retrait Mobile Money : 0 FCFA.
                                </strong>{" "}
                                Edulvoire prend intégralement en charge vos
                                frais de virement Wave, Orange, MTN & Moov.
                            </span>
                        </div>
                        ...
                        <div className="pt-2 space-y-3">
                            <div className="flex justify-between items-center text-xs">
                                <span className="font-bold text-slate-900">
                                    Projection d'inscrits pour le premier mois
                                </span>
                            ...
                            <div className="bg-emerald-50/80 border border-emerald-200/80 p-4 rounded-xl flex items-center justify-between">
                                ...
                                <span className="text-xl font-black text-emerald-900">
                                    {estimatedTotalRevenue.toLocaleString(
                                        "fr-FR",
                                    )}{" "}
                                    FCFA
                                </span>
                            ...
                            <span className="text-[10px] text-gray-400 block text-right font-medium">
                                crédités sur votre compte le 1er du mois
                                prochain
                            </span>
                        </div>
                    </div>
                        ...
                        <div className="border border-gray-200 rounded-2xl overflow-hidden shadow-xs space-y-3 bg-white">
                            <div className="relative">
                                ...
                                <span className="absolute bottom-3 right-3 bg-black/70 backdrop-blur-xs text-white text-[9px] font-bold px-2 py-0.5 rounded flex items-center gap-1">
                                    <Clock className="w-3 h-3" /> 5h 10m (12
                                    leçons HD)
                                </span>
                            </div>
                            ...
                            <div className="p-4 space-y-2.5">
                                <h4 className="font-extrabold text-sm text-slate-900 leading-snug">
                                    Physique-Chimie Terminale D : Réussir les
                                    épreuves du BAC ivoirien
                                </h4>
                                ...
                                <div className="flex items-center gap-2 text-xs text-gray-500">
                                    ...
                                    <span className="font-semibold text-slate-800">
                                        Dr. Yao N'guessan (INP-HB Yamoussoukro)
                                    </span>
                                </div>
                                ...
                                <div className="flex items-center gap-1 text-amber-500 text-xs font-bold">
                                    ...
                                    <span className="text-slate-900 font-extrabold text-xs ml-1">
                                        5.0
                                    </span>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-200 shadow-xs p-5 space-y-4">
                        ...
                        <div className="space-y-2.5 text-xs">
                            <div className="flex items-center gap-2.5 text-slate-800">
                                ...
                                <span>
                                    12 capsules vidéo encodées et testées en
                                    multi-débit
                                </span>
                            </div>
                            ...
                            <div className="flex items-center gap-2.5 text-slate-800">
                                <CheckCircle2 className="w-4 h-4 text-emerald-700 flex-shrink-0" />
                                <span>
                                    4 fiches d'exercices corrigés PDF
                                    téléchargeables
                                </span>
                            </div>
                            ...
                            <div className="flex items-center gap-2.5 text-slate-800">
                                <CheckCircle2 className="w-4 h-4 text-emerald-700 flex-shrink-0" />
                                <span>
                                    Au moins 1 quiz d'évaluation interactif
                                    activé
                                </span>
                            </div>
                            ...
                            <div className="flex items-center gap-2.5 text-slate-800">
                                <CheckCircle2 className="w-4 h-4 text-emerald-700 flex-shrink-0" />
                                <span>
                                    Miniature haute résolution 16:9 conforme aux
                                    standards
                                </span>
                            </div>
                            ...
                            <div className="flex items-center gap-2.5 text-slate-800">
                                <CheckCircle2 className="w-4 h-4 text-emerald-700 flex-shrink-0" />
                                <span>
                                    Référentiel national aligné sur le programme
                                    DECO 2024-2025
                                </span>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-200 shadow-xs p-5 space-y-4">
                        ...
                        <div className="space-y-3">
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <span className="text-[10px] text-gray-500">
                                        Visible dans le catalogue national dès
                                        la validation du livre
                                    </span>
                                </div>
                            </label>
                            ...
                            >
                                ...
                                <div>
                                    <span className="font-bold text-xs text-slate-900 block">
                                        Programmer la date de lancement
                                    </span>
                                    <span className="text-[10px] text-gray-500">
                                        Définir un jour précis de la révision de
                                        l'accès
                                    </span>
                                </div>
                            </label>
                        ...
                        <div className="bg-gray-50 p-3 rounded-xl border border-gray-100 text-[10px] text-gray-500 space-y-1">
                            ...
                            <p className="leading-relaxed">
                                En publiant ce cours, vous certifiez être
                                l'auteur légal des contenus vidéo et supports
                                pédagogiques. Tout dépôt d'un cours est protégé
                                conformément au code de la propriété
                                intellectuelle de Côte d'Ivoire.
                            </p>
                        </div>
                    </div>
                </div>
