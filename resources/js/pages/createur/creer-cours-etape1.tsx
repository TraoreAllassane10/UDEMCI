...
export default function CourseCreationStep1Page() {
            ...
            <div className="bg-gray-50/70 text-slate-800 min-h-screen font-sans pb-16">
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8 pt-6 pb-2">
                    ...
                    <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                        {/* STEP 1 (ACTIVE) */}
                        <div className="bg-white border-2 border-emerald-700 rounded-2xl p-3.5 flex items-center gap-3 shadow-xs">
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8 pt-6">
                            ...
                            <div className="bg-white rounded-2xl border border-gray-200 shadow-xs p-6 space-y-5">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <p className="text-[10px] text-gray-400">
                                        Privilégiez un titre précis mentionnant
                                        la classe et l'objectif d'examen
                                        national (BAC, BEPC).
                                    </p>
                                </div>

                                {/* Sous-titre / Accroche promotionnelle */}
                                <div className="space-y-1.5">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-xs md:text-sm text-slate-800 font-medium focus:outline-hidden focus:ring-2 focus:ring-emerald-700/20 focus:border-emerald-700 transition-all"
                                        placeholder="Accroche en une phrase courte..."
                                    />
                                </div>
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between items-center text-xs">
                                        ...
                                        <span className="text-emerald-800 font-semibold text-[11px] flex items-center gap-1 cursor-pointer hover:underline">
                                            <Info className="w-3.5 h-3.5" />{" "}
                                            Support LaTeX inclus
                                        </span>
                                    </div>
                            ...
                            <div className="bg-white rounded-2xl border border-gray-200 shadow-xs p-6 space-y-5">
                                ...
                                <div className="space-y-1.5 pt-2">
                                    ...
                                    <select className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-xs md:text-sm text-slate-900 font-semibold focus:outline-hidden focus:ring-2 focus:ring-emerald-700/20 focus:border-emerald-700 transition-all">
                                        <option>
                                            Français - Conforme aux programmes
                                            ivoiriens MENA (Ministère de
                                            l'Éducation)
                                        </option>
                                        <option>
                                            Français - Enseignement Supérieur &
                                            Concours Administratifs
                                        </option>
                                        <option>
                                            Anglais - English National
                                            Curriculum
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div className="lg:col-span-4 space-y-6">
                            ...
                            <div className="bg-white rounded-2xl border border-gray-200 shadow-xs p-5 space-y-4">
                                ...
                                <div className="border-2 border-dashed border-gray-200 rounded-xl p-4 text-center hover:border-emerald-600 transition-colors cursor-pointer bg-gray-50/50">
                                    ...
                                    <span className="text-[10px] text-gray-400 mt-0.5 block">
                                        1280 x 720 px recommandé (PNG, JPG ou
                                        WEBP max 5Mo)
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl border border-gray-200 shadow-xs p-5 space-y-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-[10px] text-gray-400">
                                        Prix conseillé pour un programme complet
                                        de terminale : entre 10 000 et 25 000
                                        FCFA.
                                    </p>
                                </div>
                                ...
                                <div className="pt-2 border-t border-gray-100 flex items-center justify-between">
                                    <div>
                                        ...
                                        <span className="text-[10px] text-gray-400">
                                            Booste vos inscriptions dès la mise
                                            en ligne
                                        </span>
                                    </div>
                                    <button
                                        onClick={() =>
                                            setIsPromoEnabled(!isPromoEnabled)
                                        }
                                ...
                                <div className="bg-gray-50 p-3 rounded-xl border border-gray-100 space-y-1 text-[11px] text-gray-500">
                                    ...
                                    <p className="text-[10px] leading-relaxed">
                                        Les apprenants paient directement par
                                        Wave, Orange Money ou MTN MoMo. Vos
                                        gains sont reversés sans frais de change
                                        sur votre compte mobile local.
                                    </p>
                    ...
                    <div className="mt-10 bg-white border border-gray-200 rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xs">
                        <div className="flex items-center gap-2 text-xs font-semibold text-emerald-800">
                            ...
                            <span>Étape 1 sur 4 complétée à 100%</span>
                        </div>

                        <div className="flex items-center gap-3 w-full sm:w-auto">
                            <button className="w-full sm:w-auto px-5 py-2.5 rounded-xl border border-gray-200 text-xs font-bold text-gray-600 hover:bg-gray-50 transition-colors">
                                Annuler
                            </button>
